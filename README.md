...
- **Case studies** — real-world documentation engineering projects (Postman automation, MCP servers, and more)
- **Writing samples** — examples of technical writing across different formats and audiences

## Tech stack

- [Astro](https://astro.build) + [Starlight](https://starlight.astro.build) for the site framework
